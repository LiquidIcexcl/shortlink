package org.liquidice.shortlink.project.common.constant;
...
public class RedisKeyConstant {
     ...
     */
    public static final String SHORT_LINK_STATS_STREAM_TOPIC_KEY = "short-link:stats-stream:only-group";
