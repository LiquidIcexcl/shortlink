package org.liquidice.shortlink.gateway.filter;

import com.alibaba.fastjson2.JSON;
import com.alibaba.fastjson2.JSONObject;
import org.liquidice.shortlink.gateway.config.Config;
import org.liquidice.shortlink.gateway.dto.GatewayErrorResult;
...
/**
 * SpringfCloud Gateway Token 拦截器
 */
@Component
public class TokenValidateGatewayFilterFactory extends AbstractGatewayFilterFactory<Config> {
        ...
        return (exchange, chain) ->{
            ...
            if (!isPathInWhiteList(requestPath, requestMethod, config.getWhitePathList())) {
                ...
                if (StringUtils.hasText(username)
                        ...
                        && (userInfo = stringRedisTemplate.opsForHash().get("shortlink:login:"+username, token))!=null) {
                ...
                return response.writeWith(Mono.fromSupplier(()->{
                    ...
                    GatewayErrorResult resultMessage = GatewayErrorResult.builder()
                            ...
                            .message("Token validation error && message from gateway")
                            .build();
    ...
    private boolean isPathInWhiteList(String requestPath, String requestMethod, List<String> whitePathList) {
        return (!CollectionUtils.isEmpty(whitePathList)
                    ...
                    || (Objects.equals(requestPath, "/api/shortlink/amin/v1/user")
