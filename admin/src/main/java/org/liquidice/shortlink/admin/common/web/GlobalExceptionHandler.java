package org.liquidice.shortlink.admin.common.web;
...
public class GlobalExceptionHandler {
    ...
    public Result defaultErrorHandler(HttpServletRequest request, Throwable throwable) {
        ...
        if (Objects.equals(throwable.getClass().getSuperclass().getSimpleName(),
            ...
            String errorCode = ReflectionUtil.getFieldValue(throwable, "errorCode").toString();
            String errorMessage = ReflectionUtil.getFieldValue(throwable, "errorMessage").toString();
