...
import org.liquidice.shortlink.admin.common.convention.exception.ClientException;
...
import org.liquidice.shortlink.admin.dao.entity.GroupUniqueDO;
import org.liquidice.shortlink.admin.dao.mapper.GroupMapper;
import org.liquidice.shortlink.admin.dao.mapper.GroupUniqueMapper;
...
import org.liquidice.shortlink.admin.remote.dto.resp.ShortLinkGroupCountQueryRespDTO;
import org.liquidice.shortlink.admin.service.GroupService;
import org.liquidice.shortlink.admin.toolkit.RandomGenerator;
...
import static org.liquidice.shortlink.admin.common.constant.RedisCacheConstant.LOCK_GROUP_CREATE_KEY;
...
public class GroupServiceImpl extends ServiceImpl<GroupMapper, GroupDO> implements GroupService {
    ...
    public void saveGroup(String username, String groupName) {
        ...
        try {
            ...
            if (CollUtil.isNotEmpty(groupDOList) && groupDOList.size() == groupMaxNum) {
               throw new ClientException(String.format("已到达最大分组数量：%d", groupMaxNum));
            }
            int retryCount = 0;
            int maxRetries = 10;
            String gid = null;
    ...
    public List<ShortLinkGroupRespDTO> listGroup() {
        ...
        List<ShortLinkGroupRespDTO> shortLinkGroupRespDTOList = BeanUtil.copyToList
                (groupDOList, ShortLinkGroupRespDTO.class);
